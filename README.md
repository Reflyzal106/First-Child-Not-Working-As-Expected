# [SOLVED] First-Child-Not-Working-As-Expected
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/first-child-not-working-as-expected)
>
...
Use the :first-of-type pseudo-class instead, which targets the first element of its type within a parent container.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/first-child-not-working-as-expected)**
